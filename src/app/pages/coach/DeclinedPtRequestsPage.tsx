...
const DeclinedPtRequestsPage = ({navigation}) => {
  ...
  const declinedRequests = [
    ...
    { id: '2', player: 'Emma Thompson', date: '2024-07-21', time: '11:00-12:00', location: 'Court B', reason: 'Court maintenance' },
    { id: '3', player: 'Frank Miller', date: '2024-07-22', time: '17:00-18:00', location: 'Court C', reason: 'Coach unavailable' },
    // Add more declined requests as needed
  ]

  const renderDeclinedRequest = ({ item }) => (
    <View className="p-4 mb-4 bg-white border-l-4 border-red-500 shadow-md dark:bg-gray-800 rounded-xl">
  ...
  return (
    <AppLayout>
      ...
      <FlatList
        ...
        renderItem={renderDeclinedRequest}
...
export default DeclinedPtRequestsPage