    ...
    <View className="p-4 mb-4 bg-white border-l-4 border-green-500 shadow-md dark:bg-gray-800 rounded-xl">
      <View className="flex-row items-center justify-between mb-2">
        ...
        <View className="px-2 py-1 bg-green-100 rounded-full dark:bg-green-800">
          <Text className="text-xs font-medium text-green-800 dark:text-green-100">Approved</Text>
        </View>
      </View>
      <View className="flex-row items-center justify-between mb-2">
      ...
      <Text className="mt-2 text-sm text-gray-500 dark:text-gray-400">Focus: {item.focus}</Text>
  ...
  return (
    <AppLayout>
      <View className='flex-row items-center justify-between w-full mb-6'>
        ...
        <Text className="text-2xl font-bold text-black dark:text-white">Approved Requests</Text>
        <TouchableOpacity>
