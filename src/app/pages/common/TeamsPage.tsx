    ...
    <AppLayout>
      <ScrollView className="w-full h-full">
        <View className="flex flex-col items-center">
          ...
          {teams.map(team => (
            <TouchableOpacity onPress={() => navigation.navigate('TeamDetailPage',{teamId: team.id})} key={team.id} className="flex flex-row items-center justify-between w-full p-5 my-2 rounded-lg bg-dacka-dark-gray">
