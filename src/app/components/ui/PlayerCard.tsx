...
const PlayerCard = ({ name, dateOfBirth, image, selected, onPress }: PlayerCardProps) => {
  return (
    <TouchableOpacity onPress={onPress} className={`flex-row items-center justify-between w-full p-4 my-3 ${selected ? 'bg-green-500' : 'bg-dacka-dark-gray'}`}>
      <View>
        <View className='mb-3'>
