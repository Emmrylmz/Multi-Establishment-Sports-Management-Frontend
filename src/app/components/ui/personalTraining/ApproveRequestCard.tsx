...
const ApproveRequestCard = ({name,location,duration,startTime,endTime,description}: ApproveRequestCardProps) => {
  return (
<TouchableOpacity
          ...
          <View className="flex-row justify-between mb-4">
            <View className="flex-1">
              ...
              <Text className="text-base font-semibold text-black dark:text-white">{location}B</Text>
            </View>
